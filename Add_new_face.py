...
class Face_Register:
        ...
        def GUI_info(self):
            ...
            tk.Button(self.frame_right_info,
                      text="Submit",
                      command=self.Submit,font=tkFont.Font(family='Helvetica', size=15, weight='bold'),fg='black',bg='red').grid(row=10,column=2,columnspan=4,sticky=tk.W)
