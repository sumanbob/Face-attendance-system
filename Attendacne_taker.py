...
current_date = datetime.datetime.now().strftime('%d-%m-%y')  # Replace hyphens with underscores
...
class Face_Recognizer:
    ...
    def get_face_database(self):
        if os.path.exists("data/features_all.csv"):
            ...
            logging.warning("Please  'Add the face and hit submit' ")
            return 0
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "Taking attendance", (20, 40), self.font, 1, (255, 255, 255), 1, cv2.LINE_AA)
